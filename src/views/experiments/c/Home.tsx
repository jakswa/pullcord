export const HomePage = () => (
  <div class="home-shell">
    {/* Hero — warm, inviting, action-forward */}
    <div class="home-hero">
      <div class="home-hero-inner">
        <div class="home-brand">
          {/* Pull cord handle logo — the thing you tug to request your stop */}
        ...
        <div class="home-search-wrap">
          <input
            ...
            id="stop-search"
            class="home-search"
            placeholder="Or search for a stop..."
            autocomplete="off"
          />
        </div>
      </div>
    ...
    <div class="home-footer">
      <p>Real-time MARTA bus tracking — data refreshes every 30s</p>
