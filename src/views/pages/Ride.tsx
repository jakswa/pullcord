...
export const RidePage = ({ tripId, stopId, routeId }: { tripId: string; stopId: string; routeId: string }) => (
  <div class="ride-shell">
    ...
    <div class="ride-header">
      <a href={stopId ? (routeId ? `/bus?route=${routeId}&stop=${stopId}` : `/bus?stop=${stopId}`) : "/"} class="ride-back" aria-label="Back" onclick="if(history.length>1){history.back();return false}">
